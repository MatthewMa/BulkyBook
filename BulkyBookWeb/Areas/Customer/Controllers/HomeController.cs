...
public class HomeController : Controller
{
    ...
    public IActionResult Details(ShoppingCart shoppingCart)
    {
        ...
        var shoppingCartFound = _unitOfWork.ShoppingCart.GetFirstOrDefault(s => (s.ApplicationUserId == shoppingCart.ApplicationUserId) && (s.ProductId == shoppingCart.ProductId));
        ...
        {           
            _unitOfWork.ShoppingCart.IncrementCount(shoppingCartFound, shoppingCart.Count);
